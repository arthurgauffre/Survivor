"""Adding all tables for the project to work

Revision ID: 4fd65b462beb
Revises: 50d6c78de892
Create Date: 2024-09-03 09:35:29.104212
...
revision: str = '4fd65b462beb'
down_revision: Union[str, None] = '50d6c78de892'
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f('ix_customers_astrologicalSign'),
        'customers',
        ['astrologicalSign'],
        unique=False)
    op.create_index(
        op.f('ix_customers_birthdate'),
        'customers',
        ['birthdate'],
        unique=False)
    op.create_index(
        op.f('ix_customers_clothesType'),
        'customers',
        ['clothesType'],
        unique=False)
    op.create_index(
        op.f('ix_customers_description'),
        'customers',
        ['description'],
        unique=False)
    op.create_index(
    ...
    op.create_index(
        ...
        unique=False)
    op.create_index(
        op.f('ix_customers_password'),
        'customers',
        ['password'],
        unique=False)
    op.create_index(
        op.f('ix_customers_surname'),
        'customers',
        ['surname'],
        unique=False)
    op.create_table('employees',
                    ...
                    sa.Column('profilePictureLink', sa.String(), nullable=True),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_index(
        op.f('ix_employees_birthdate'),
        'employees',
        ['birthdate'],
        unique=False)
    op.create_index(
    ...
    op.create_index(
        ...
        unique=False)
    op.create_index(
        op.f('ix_employees_password'),
        'employees',
        ['password'],
        unique=False)
    op.create_index(
        op.f('ix_employees_profilePictureLink'),
        'employees',
        ['profilePictureLink'],
        unique=False)
    op.create_index(
        op.f('ix_employees_surname'),
        'employees',
        ['surname'],
        unique=False)
    op.create_index(
        op.f('ix_employees_work'),
        'employees',
        ['work'],
        unique=False)
    ...
    op.create_index(
        op.f('ix_encounters_comment'),
        'encounters',
        ['comment'],
        unique=False)
    op.create_index(
        op.f('ix_encounters_date'),
        'encounters',
        ['date'],
        unique=False)
    op.create_index(
        op.f('ix_encounters_id'),
        'encounters',
        ['id'],
        unique=False)
    op.create_index(
        op.f('ix_encounters_rating'),
        'encounters',
        ['rating'],
        unique=False)
    op.create_index(
        op.f('ix_encounters_source'),
        'encounters',
        ['source'],
        unique=False)
    ...
    op.create_index(
        op.f('ix_events_location_name'),
        'events',
        ['location_name'],
        unique=False)
    op.create_index(
        op.f('ix_events_location_y'),
        'events',
        ['location_y'],
        unique=False)
    op.create_index(
        op.f('ix_events_max_participants'),
        'events',
        ['max_participants'],
        unique=False)
    op.create_index(op.f('ix_events_name'), 'events', ['name'], unique=False)
    op.create_index(op.f('ix_events_type'), 'events', ['type'], unique=False)
    op.create_foreign_key(None, 'events', 'employees', ['employee_id'], ['id'])
...
def downgrade() -> None:
    ...
    op.drop_column('events', 'employee_id')
    op.drop_column('events', 'type')
    op.drop_column('events', 'location_y')

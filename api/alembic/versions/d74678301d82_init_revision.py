...
Revision ID: d74678301d82
Revises: 
Create Date: 2024-09-03 17:26:08.089956
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_employees_profilePictureLink'), 'employees', ['profilePictureLink'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_employees_profilePictureLink'), table_name='employees')
